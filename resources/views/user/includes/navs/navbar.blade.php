            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="#">
                                <i class="ft-user"></i> الاعدادات
                            </a>
                            <div class="dropdown-divider"></div>

                            <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                <i class="ft-power"></i> الخروج
                            </a>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        @php
                            $notifications = App\Models\Notifications\Notification::where('user_id', Auth::user()->id)->where('isRead', 0)->orderBy('created_at', 'desc')->get();
                            Carbon\Carbon::setLocale('ar');
                        @endphp
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown">
                            <i class="ficon ft-bell"></i>
                            <span class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow" id="notification-counter">{{ $notifications->count() }}</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <span class="notification-tag badge badge-default badge-danger float-right m-0">0 اشعارات</span>
                            </li>
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <small>
                                                <time class="media-meta text-muted" datetime="2015-06-11T18:29:20+08:00">{{ Carbon\Carbon::parse($notification->created_at)->diffForHumans() }}</time>
                                            </small>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <li class="dropdown-menu-footer">
                                <a class="dropdown-item text-muted text-center" href="javascript:void(0)">قراءة جميع الاشعارات</a>
                            </li>
                        </ul>
                    </li>
                </ul>
