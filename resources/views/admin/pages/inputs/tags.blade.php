    ...
    <div class="col-xl-6 col-lg-12">
        ...
        <div class="card-content collapse show">
            ...
            <fieldset>
                ...
                <p class="text-muted">By default <code>case-sensitive</code> is <code>false</code>.
                    Set it to <code>true</code> to allow case sensitive.</p>
                </div>
            </fieldset>
            <!-- Disable Close Char -->
            <fieldset>
                ...
                <p class="text-muted">By default close char is <code>"&times;"</code>. Pass empty
                    string <code>close-char:""</code> To remove close char.</p>
                </div>
            </fieldset>
            ...
            <fieldset>
                ...
                <p class="text-muted">By default you can edit the tag you just deleted from the
                    tag box. set it <code>edit-on-delete:false</code> to avoid
                    that.
                </p>
                </div>
            </fieldset>
            ...
            <fieldset>
                ...
                <p class="text-muted">Comma <code>","</code> key add a new tag by default, set
                    it <code>no-comma:true</code> to avoid that.</p>
                </div>
            </fieldset>
            </div>
        </div>
    ...
    <div class="col-xl-6 col-lg-12">
        ...
        <div class="card-content collapse show">
            ...
            <fieldset>
                ...
                <p class="text-muted">If <code>false</code>, clicking away from the $type_zone
                    won't add a new tag.</p>
                </div>
            </fieldset>
            <!-- Tag Char -->
            <fieldset>
